...
public class ExpandableListDataPump {
    public static LinkedHashMap<String, List<String>> getData() {
       ...
       Kalima.add("১. সমস্ত মুখমন্ডল কপালের উপরিভাগের চুলের গোড়া হইতে থুতনী পর্যন্ত\n" +
               "এক কর্নের লতি থেকে অন্য কর্নের লতি পর্যন্ত ধৌত করা।\n" +
               "\n" +
               "২.উভয় হাত কনুইসহ ধৌত করা।\n" +
               "\n" +
               "৩.চারভাগের একভাগ মাথা মাসেহ করা \n" +
               " ( ঘন দাঁড়ি থাকিলে আঙ্গুলী দ্বারা খেলাল করা ফরয )।\n" +
               "\n" +
       ...
       sunnah.add("1. নিয়ত করা\n" +
        ...
        expandableListDetail.put("2.Sunnah", sunnah);
        expandableListDetail.put("5.Others", Others);
        expandableListDetail.put("1.Four Faraz in Ozu", Kalima);
        expandableListDetail.put("4.Ozu er Dua", Ozudua);
        expandableListDetail.put("3.Taiamun", Taiamun);
